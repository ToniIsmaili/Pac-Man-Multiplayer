...
public class PinkController : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        else
        {
            ...
            Direction newDirection = FindPath(scattering? new Vector2(16.5f, -16.5f) : (Vector2)GameObject.FindWithTag("PacMan").transform.position + (4 * GameObject.FindWithTag("PacMan").GetComponent<MovementController>().direction));
